...
class DataTrainingArguments:
    ...
    deid_strategy: Optional[str] = field(
        default="ai_cup",
        metadata={"help": "deid_strategy"}
    )
    notation: str = field(
        default="BIO",
        metadata={"help": "NER notation e.g BIO"},
    )
    output_AI_cup_prediction_file: Optional[str] = field(
        default=None,
        metadata={"help": "AI cup model prediction result file"}
    )
